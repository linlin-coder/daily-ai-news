...
4. **过渡词癌**（删掉所有）：
   - ❌ 首先/其次/然后/此外/而且/更重要的是/总之
   - ✅ 用具体数字/具体名词承接，或直接换段

5. **段落均匀**（制造起伏）：
   - ❌ 每段都是3-4句
   - ✅ 有的段1句话（8字），有的段8句话，有的段就3个字"是的。"

6. **人称切换不自然**（锁定1个主要人称）：
   - ❌ 一段内切换"我们/你/大家/笔者"
   - ✅ 全文锁定"我"或"你"，偶尔切换有明确目的
...
8. **空洞数据**（替换为具体数字或案例）：
   - ❌ "据相关研究表明..."
   - ✅ "Statista 2024年数据显示..." 或 "我去年帮3个朋友做过这事，全失败了。"
